...
# --- Step 3: launch simulation (no real robot / SSH needed) -----------------
step3_sim() {
    echo "== Launch simulation =="
    echo "Running: ros2 launch robile_gazebo gazebo_4_wheel.launch.py"
...
========================================
 ...
 3) Launch simulation (no real robot needed)
